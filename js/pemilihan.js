  ...
  const candidatesData = [
    {
      ...
      image: "https://placehold.co/300x225/1e293b/ffffff?text=Vina+%26+Hadi",
      vision:
    ...
    },
    {
      ...
      image:
        "https://placehold.co/300x225/1e293b/ffffff?text=Salsabila+%26+Bima",
      vision:
    ...
    },
    {
      ...
      image: "https://placehold.co/300x225/1e293b/ffffff?text=Nadia+%26+Rizki",
      vision:
    ...
    return `
                    <div class="candidate-card w-72 rounded-lg p-3 flex flex-col text-left">
                        ...
                        <div class="relative w-full aspect-[4/3] mb-1.5">
                            <img src="${
                              candidate.image
                            }" alt="${memberNames}" class="w-full h-full object-cover rounded-lg shadow-md" onerror="this.src='https://placehold.co/300x225/334155/e2e8f0?text=Image+Not+Found'">
                        </div>
    ...
    modalDialog.innerHTML = `
      ...
      candidate.name
                            ...
                            <div class="md:w-2/3 pr-2 max-h-[50vh]">
                                ...
                                <ul class="space-y-3 text-slate-300 overflow-y-auto max-h-48 modal-scroll-content">
                                    ${missionListItems}
                                </ul>
                            </div>
                        </div>
